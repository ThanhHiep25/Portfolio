      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {loading ? (
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <Skeleton variant="text" height={48} width="60%" className="mb-8" />
            ...
            <div className="space-y-12">
              <div>
                <Skeleton variant="text" height={32} width="40%" className="mb-8" />
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-6 text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-10">
                {user.profile.map((p) => (
              ...
              <div className="grid grid-cols-2 gap-8 mb-8">
                ...
                >
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400 uppercase font-bold tracking-widest">Năm kinh nghiệm</div>
                </motion.div>
                <motion.div
                  whileHover={{ y: -5 }}
                  className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-2xl border border-gray-100 dark:border-gray-800"
                >
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400 uppercase font-bold tracking-widest">Dự án hoàn tất</div>
                </motion.div>
              </div>
            </motion.div>
                ...
                <div className="border-l-2 border-primary/20 ml-5 space-y-10 pl-8 pb-2">
                  {user.experience.map((exp) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wider">{exp.experience_year} | {exp.experience_location}</p>

                      <ul className="list-disc pl-5 space-y-2">
                        {
                          exp.experience_step1 && (
                            <li className="text-gray-700 text-justify dark:text-gray-300 font-medium leading-relaxed">{exp.experience_step1}</li>
                          )
                        }
                        {
                          exp.experience_step2 && (
                            <li className="text-gray-700 text-justify dark:text-gray-300 font-medium leading-relaxed">{exp.experience_step2}</li>
                          )
                        }
                        {
                          exp.experience_step3 && (
                            <li className="text-gray-700 text-justify dark:text-gray-300 font-medium leading-relaxed">{exp.experience_step3}</li>
                          )
                        }
                        {
                          exp.experience_step4 && (
                            <li className="text-gray-700 text-justify dark:text-gray-300 font-medium leading-relaxed">{exp.experience_step4}</li>
                          )
                        }
                        {
                          exp.experience_step5 && (
                            <li className="text-gray-700 text-justify dark:text-gray-300 font-medium leading-relaxed">{exp.experience_step5}</li>
                          )
                        }
                      </ul>
                ...
                <div className="border-l-2 border-primary/20 ml-5 space-y-10 pl-8 pb-2">
                  {user.education.map((edu) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">{edu.education_year}</p>
                      <p className="text-gray-700 dark:text-gray-300 font-medium leading-relaxed">{edu.education_des}</p>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
