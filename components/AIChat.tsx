...
import { Send, X, Bot, User, Minimize2, Loader2, Sparkles, Maximize2 } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { chatWithOpenRouterStream } from '../services/openRouterService';
              ...
              >
                ...
                >
                  {messages.map((msg, idx) => (
                    ...
                    >
                      <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 shadow-sm ${msg.role === 'user' ? 'bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-400' : 'bg-primary text-white'
                        }`}>
                        {msg.role === 'user' ? <User size={14} /> : <Bot size={14} />}
                      </div>
                      <div className={`p-3.5 sm:p-4 rounded-2xl text-xs sm:text-[13px] leading-relaxed max-w-[85%] font-medium shadow-sm ${msg.role === 'user'
