...
const imgChatPlatform = "https://images.unsplash.com/photo-1611746872915-64382b5c76da?auto=format&fit=crop&q=80&w=1200";
const imgRecipeApp = "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=1200";
const imgMassageSys = "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&q=80&w=1200";

const iuh = "https://media.iuh.edu.vn/Media/2_sviuh/Images/logo-iuh_817e997a-e377-4951-bd1f-b51f04664887.png";
const alis = "https://images.unsplash.com/photo-1586717791821-3f44a563eb4c?auto=format&fit=crop&q=80&w=800"; 

const sof = "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=80&w=800";
const har = "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=800";
    ...
    experience: [
      {
        ...
        experience_img: "",
        experience_name: "Front-end Developer - ReactJS & (Golang basic)",
        experience_year: "1/1/2025 - Hiện tại",
    ...
    project_experience: [
      {
        ...
        project_des: "Hệ thống truyền thông nội bộ quy mô lớn hỗ trợ hàng nghìn người dùng đồng thời. Tích hợp WebRTC cho cuộc gọi video và Socket.io cho tin nhắn tức thời.",
      ...
      },
      {
        ...
        project_des: "Nền tảng quản trị SaaS cho các chuỗi spa cao cấp. Xử lý quy trình đặt lịch, quản lý lương nhân viên và phân tích doanh thu qua biểu đồ trực quan.",
      ...
      },
      {
        ...
        project_des: "Ứng dụng chia sẻ công thức nấu ăn tích hợp AI nhận diện món ăn qua hình ảnh. Hệ thống gợi ý món ăn dựa trên nguyên liệu hiện có.",
      ...
      },
      {
        ...
        project_des: "Bảng điều khiển chứng khoán thời gian thực với biểu đồ tương tác cao và dữ liệu streaming liên tục.",
        project_img:'' ,
        ...
        project_des: "Ứng dụng thương mại điện tử với trải nghiệm người dùng mượt mà, tích hợp thanh toán và quản lý giỏ hàng.",
        project_img: '',
